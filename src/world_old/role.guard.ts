...
let logger = new logger_imported("role.guard");
...
utils.extendFunction(obj, "init", function(name, roomManager, targetRoom) {
...
obj.prototype.runCreep = function(creep) {
  ...
  var tower = creep.pos.findClosestByRange(FIND_MY_STRUCTURES, {
    filter: function(s) {
      return s.structureType == STRUCTURE_TOWER && s.energy > 300
    }
  });

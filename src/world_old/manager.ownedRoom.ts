...
let logger = new logger_imported("manager.ownedRoom");
//logger.enabled = false;
var BuildingManagerClass = import ./manager.building;
var LabManagerClass = import ./manager.labs;
...
utils.extendFunction(obj, "init", function(roomName) {
...
obj.prototype.canSpawn = function(creepRequest, maxEnergy) {
  ...
  if (spawn) {
    ...
    //logger.log(body)
    var canSpawn = spawn.spawnCreep(body, creepRequest.getName(), {
      dryRun: true
    });
    return canSpawn == 0;
  }

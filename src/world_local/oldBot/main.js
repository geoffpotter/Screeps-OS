...
let logger = new logger_imported("main");
...
import empireManager_imported from "./manager.empire";
//profiler.registerObject(empireManager, "empire")



let empireManager = new empireManager_imported();
//console.log(JSON.stringify(empireManager));
empireManager.init();
global.empire = empireManager;


import plus from './screeps.plus';

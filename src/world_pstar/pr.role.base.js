...
let baseAction = action.classes.baseAction;
let actionOptIn = action.classes.actionOptIn;
...
class baseRole extends processClass {
    ...
    getCreepValidOptIns(creep) {
        ...
        for(let a in this.actionOptIns) {
            ...
            let actionClass = action.getActionClass(actionType);
    ...
    getCreepAction(creep) {
        ...
        if (!action) {
            ...
            if (action) {
                ...
                //creep.say("I'm bored");
                //pStar.inst.moveTo(creep, {pos:this.pos, range: 1});
            }
    ...
    display() {
        visual.drawText(this.roleName + " " + this.totalNeededParts + " " + this.totalParts, this.pos);
    }
}

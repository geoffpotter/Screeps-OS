...
global.utils = {};
global.utils.array = import util.array;
global.utils.visual = import util.visual;
global.utils.map = import util.map;
global.utils.pStar = import util.pStar;
global.utils.cm = import util.cm;
global.utils.intel = import util.intel;
global.utils.creep = import util.creep;
global.utils.action = import util.action;
...
let kernelClass = import INeRT.kernel;
...
let initProcClass = import pr.init;
let initProc = new initProcClass("init");
kernel.startProcess(initProc);

// let testProcClass = import inert.tests;
...
module.export constloop = mainLoop;

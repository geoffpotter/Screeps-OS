...
let actionManager = import pr.actionManager;
let roomObjectClass = import pr.roomObject;

let workerRoleClass = import pr.role.worker;
let minerRoleClass = import pr.role.miner;
